...
import {FaBars,FaTimes,FaTachometerAlt,FaBriefcase,FaClipboardList,FaUser,FaSignOutAlt,} from "react-icons/fa";
  ...
  <>
    ...
    >
        ...
        <div className="student-sidebar-user">
            ...
            <div>
                <p className="student-sidebar-user-name">
                    {user?.fullName || "Student"}
                </p>

                <p className="student-sidebar-user-role">
                    Student
                </p>
            </div>
        </div>
        ...
        <nav className="student-sidebar-nav">
            {LINKS.map((link) => (
                ...
                >
                    <span className="student-sidebar-link-icon">
                        {link.icon}
                    </span>
